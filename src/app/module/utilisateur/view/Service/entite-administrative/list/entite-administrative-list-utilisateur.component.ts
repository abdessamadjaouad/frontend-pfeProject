...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'chefService?.ref', header: 'Chef service'},
        ];
    }


    public async loadChefService(){
        this.agentService.findAllOptimized().subscribe(chefServices => this.chefServices = chefServices, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Ref': e.ref ,
                 'Libelle': e.libelle ,
                'Chef service': e.chefService?.ref ,
            }
        });
        ...
        //'Chef service': this.criteria.chefService?.ref ? this.criteria.chefService?.ref : environment.emptyForExport ,
        }];
      }
