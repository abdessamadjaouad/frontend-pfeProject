...
@Component({
  selector: 'app-heure-supplementaire-create-utilisateur',
  templateUrl: './heure-supplementaire-create-utilisateur.component.html'
})
export class HeureSupplementaireCreateUtilisateurComponent  implements OnInit {
