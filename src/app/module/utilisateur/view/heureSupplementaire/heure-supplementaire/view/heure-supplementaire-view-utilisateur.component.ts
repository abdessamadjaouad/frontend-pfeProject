...
@Component({
  selector: 'app-heure-supplementaire-view-utilisateur',
  templateUrl: './heure-supplementaire-view-utilisateur.component.html'
})
export class HeureSupplementaireViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: HeureSupplementaireUtilisateurService){
