...
@Component({
  selector: 'app-heure-supplementaire-edit-utilisateur',
  templateUrl: './heure-supplementaire-edit-utilisateur.component.html'
})
export class HeureSupplementaireEditUtilisateurComponent implements OnInit {
