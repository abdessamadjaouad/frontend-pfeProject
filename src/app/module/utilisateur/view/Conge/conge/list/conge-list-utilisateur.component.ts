...
import {CongeUtilisateurService} from 'src/app/shared/service/utilisateur/Conge/CongeUtilisateur.service';
...
@Component({
  selector: 'app-conge-list-utilisateur',
  templateUrl: './conge-list-utilisateur.component.html'
})
export class CongeListUtilisateurComponent implements OnInit {

    protected fileName = 'Conge';
    ...
    constructor( private service: CongeUtilisateurService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CongeDto>();
    ...
    public async edit(dto: CongeDto) {
    ...
    public async view(dto: CongeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CongeDto) {
    ...
    public async duplicate(dto: CongeDto) {
    ...
    public exportPdf(dto: CongeDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'typeConge', header: 'Type conge'},
        ];
    }
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            ...
            'Type conge': this.criteria.typeConge ? this.criteria.typeConge : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<CongeDto> {
        return this.service.selections;
    }

    set selections(value: Array<CongeDto>) {
    ...
    get criteria(): CongeCriteria {
        return this.service.criteria;
    }

    set criteria(value: CongeCriteria) {
