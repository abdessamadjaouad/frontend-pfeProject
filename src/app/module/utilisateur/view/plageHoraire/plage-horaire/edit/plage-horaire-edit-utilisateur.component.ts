...
@Component({
  selector: 'app-plage-horaire-edit-utilisateur',
  templateUrl: './plage-horaire-edit-utilisateur.component.html'
})
export class PlageHoraireEditUtilisateurComponent implements OnInit {
