...
@Component({
  selector: 'app-plage-horaire-view-utilisateur',
  templateUrl: './plage-horaire-view-utilisateur.component.html'
})
export class PlageHoraireViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: PlageHoraireUtilisateurService){
