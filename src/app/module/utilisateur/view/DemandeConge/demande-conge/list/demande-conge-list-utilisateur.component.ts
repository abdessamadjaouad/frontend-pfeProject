...
@Component({
  selector: 'app-demande-conge-list-utilisateur',
  templateUrl: './demande-conge-list-utilisateur.component.html'
})
export class DemandeCongeListUtilisateurComponent implements OnInit {

    protected fileName = 'DemandeConge';
    ...
    raisonDemandeConges: Array<RaisonDemandeCongeDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DemandeCongeDto>();
    ...
    public async edit(dto: DemandeCongeDto) {
    ...
    public async view(dto: DemandeCongeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DemandeCongeDto) {
    ...
    public async duplicate(dto: DemandeCongeDto) {
    ...
    public exportPdf(dto: DemandeCongeDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'raisonDemandeConge?.libelle', header: 'Raison demande conge'},
        ];
    }


    public async loadRaisonDemandeConge(){
        this.raisonDemandeCongeService.findAllOptimized().subscribe(raisonDemandeConges => this.raisonDemandeConges = raisonDemandeConges, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Raison demande conge': e.raisonDemandeConge?.libelle ,
            }
        });
        ...
        //'Raison demande conge': this.criteria.raisonDemandeConge?.libelle ? this.criteria.raisonDemandeConge?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<DemandeCongeDto> {
        return this.service.selections;
    }

    set selections(value: Array<DemandeCongeDto>) {
