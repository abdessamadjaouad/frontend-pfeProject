...
@Component({
  selector: 'app-demande-conge-view-utilisateur',
  templateUrl: './demande-conge-view-utilisateur.component.html'
})
export class DemandeCongeViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: DemandeCongeUtilisateurService, private raisonDemandeCongeService: RaisonDemandeCongeUtilisateurService){
