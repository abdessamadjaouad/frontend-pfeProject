...
@Component({
  selector: 'app-absence-list-utilisateur',
  templateUrl: './absence-list-utilisateur.component.html'
})
export class AbsenceListUtilisateurComponent implements OnInit {
