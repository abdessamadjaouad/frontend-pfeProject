...
@Component({
  selector: 'app-absence-view-utilisateur',
  templateUrl: './absence-view-utilisateur.component.html'
})
export class AbsenceViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: AbsenceUtilisateurService){
