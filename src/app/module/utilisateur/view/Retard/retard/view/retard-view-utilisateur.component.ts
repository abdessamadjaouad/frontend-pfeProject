...
@Component({
  selector: 'app-retard-view-utilisateur',
  templateUrl: './retard-view-utilisateur.component.html'
})
export class RetardViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: RetardUtilisateurService, private agentService: AgentUtilisateurService){
