...
@Component({
  selector: 'app-raison-demande-absence-view-utilisateur',
  templateUrl: './raison-demande-absence-view-utilisateur.component.html'
})
export class RaisonDemandeAbsenceViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: RaisonDemandeAbsenceUtilisateurService){
