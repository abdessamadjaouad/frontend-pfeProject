...
@Component({
  selector: 'app-raison-demande-absence-create-utilisateur',
  templateUrl: './raison-demande-absence-create-utilisateur.component.html'
})
export class RaisonDemandeAbsenceCreateUtilisateurComponent  implements OnInit {
   ...
   private _validRaisonDemandeAbsenceLibelle = true;
    ...
    public  setValidation(value: boolean){
        this.validRaisonDemandeAbsenceRef = value;
        this.validRaisonDemandeAbsenceLibelle = value;
    }
    ...
    public  validateForm(): void{
        ...
        this.validateRaisonDemandeAbsenceRef();
        this.validateRaisonDemandeAbsenceLibelle();
    }

    public validateRaisonDemandeAbsenceRef(){
        if (this.stringUtilService.isEmpty(this.item.ref)) {
        this.errorMessages.push('Ref non valide');
        this.validRaisonDemandeAbsenceRef = false;
        } else {
            this.validRaisonDemandeAbsenceRef = true;
        }
    }
    public validateRaisonDemandeAbsenceLibelle(){
        if (this.stringUtilService.isEmpty(this.item.libelle)) {
        this.errorMessages.push('Libelle non valide');
        this.validRaisonDemandeAbsenceLibelle = false;
        } else {
            this.validRaisonDemandeAbsenceLibelle = true;
        }
    }
