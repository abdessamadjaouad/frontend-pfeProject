...
@Component({
  selector: 'app-poste-view-utilisateur',
  templateUrl: './poste-view-utilisateur.component.html'
})
export class PosteViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: PosteUtilisateurService){
