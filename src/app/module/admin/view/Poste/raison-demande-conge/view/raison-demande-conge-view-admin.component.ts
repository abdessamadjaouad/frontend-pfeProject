...
@Component({
  selector: 'app-raison-demande-conge-view-admin',
  templateUrl: './raison-demande-conge-view-admin.component.html'
})
export class RaisonDemandeCongeViewAdminComponent implements OnInit {
    ...
    constructor(private service: RaisonDemandeCongeAdminService){
