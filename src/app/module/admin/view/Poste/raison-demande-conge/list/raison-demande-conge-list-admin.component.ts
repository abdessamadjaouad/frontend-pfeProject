...
@Component({
  selector: 'app-raison-demande-conge-list-admin',
  templateUrl: './raison-demande-conge-list-admin.component.html'
})
export class RaisonDemandeCongeListAdminComponent implements OnInit {
