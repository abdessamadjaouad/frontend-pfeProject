...
import {AbsenceAdminService} from 'src/app/shared/service/admin/Absence/AbsenceAdmin.service';
...
export class AbsenceListAdminComponent implements OnInit {

    protected fileName = 'Absence';
    ...
    constructor( private service: AbsenceAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AbsenceDto>();
    ...
    public async edit(dto: AbsenceDto) {
    ...
    public async view(dto: AbsenceDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AbsenceDto) {
    ...
    public async duplicate(dto: AbsenceDto) {
    ...
    public exportPdf(dto: AbsenceDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            ...
            'Type absence': this.criteria.typeAbsence ? this.criteria.typeAbsence : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<AbsenceDto> {
        return this.service.selections;
    }

    set selections(value: Array<AbsenceDto>) {
