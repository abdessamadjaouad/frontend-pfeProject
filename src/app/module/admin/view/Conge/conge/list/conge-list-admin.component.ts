...
import {CongeAdminService} from 'src/app/shared/service/admin/Conge/CongeAdmin.service';
...
export class CongeListAdminComponent implements OnInit {
    ...
    constructor( private service: CongeAdminService  , @Inject(PLATFORM_ID) private platformId?) {
