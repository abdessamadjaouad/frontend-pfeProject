...
@Component({
  selector: 'app-demande-document-administratif-view-admin',
  templateUrl: './demande-document-administratif-view-admin.component.html'
})
export class DemandeDocumentAdministratifViewAdminComponent implements OnInit {
    ...
    constructor(private service: DemandeDocumentAdministratifAdminService){
