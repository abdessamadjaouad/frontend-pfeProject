...
export class PointageViewAdminComponent implements OnInit {
    ...
    constructor(private service: PointageAdminService, private agentService: AgentAdminService, private badgeNfcService: BadgeNfcAdminService){
