...
export class AgentViewAdminComponent implements OnInit {
    ...
    constructor(private service: AgentAdminService, private plageHoraireService: PlageHoraireAdminService, private entiteAdministrativeService: EntiteAdministrativeAdminService, private posteService: PosteAdminService){
