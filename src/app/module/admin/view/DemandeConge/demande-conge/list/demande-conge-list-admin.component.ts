...
export class DemandeCongeListAdminComponent implements OnInit {
    ...
    constructor( private service: DemandeCongeAdminService  , private raisonDemandeCongeService: RaisonDemandeCongeAdminService, @Inject(PLATFORM_ID) private platformId?) {
