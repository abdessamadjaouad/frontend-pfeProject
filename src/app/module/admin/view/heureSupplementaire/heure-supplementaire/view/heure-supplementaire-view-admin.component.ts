...
@Component({
  selector: 'app-heure-supplementaire-view-admin',
  templateUrl: './heure-supplementaire-view-admin.component.html'
})
export class HeureSupplementaireViewAdminComponent implements OnInit {
    ...
    constructor(private service: HeureSupplementaireAdminService){
