...
@Component({
  selector: 'app-plage-horaire-view-admin',
  templateUrl: './plage-horaire-view-admin.component.html'
})
export class PlageHoraireViewAdminComponent implements OnInit {
    ...
    constructor(private service: PlageHoraireAdminService){
