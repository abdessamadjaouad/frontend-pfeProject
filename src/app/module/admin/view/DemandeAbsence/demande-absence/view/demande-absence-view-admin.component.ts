...
@Component({
  selector: 'app-demande-absence-view-admin',
  templateUrl: './demande-absence-view-admin.component.html'
})
export class DemandeAbsenceViewAdminComponent implements OnInit {
    ...
    constructor(private service: DemandeAbsenceAdminService, private raisonDemandeAbsenceService: RaisonDemandeAbsenceAdminService){
